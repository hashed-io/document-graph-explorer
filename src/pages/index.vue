...
.flex.column
  .main-splash
    img.imgSplash(src="src/app-splashscreen.png" data-cy="imgSplash")
    ...
    .q-py-md
      ...
      .row.text-body2
          strong
            | Step 3:
          div.q-pl-md
            | Add your Articles of Organization and other docs directly to your newly deployed (and fully upgradable) Smart Contract.
      .row.text-body2
          strong
            | Step 4:
          div.q-pl-md
